...
ActiveRecord::Schema.define(version: 20160413074137) do
  ...
  create_table "campaign_bulkshippinginfos", force: true do |t|
    ...
    t.timestamp "delivery_datetime", precision: 6
    t.timestamp "created_at",        precision: 6
    t.timestamp "updated_at",        precision: 6
  end
  ...
  create_table "campaign_visit_logs", force: true do |t|
    ...
    t.integer   "seller_id"
    t.string    "remote_ip"
    t.timestamp "visited_time", precision: 6
    t.string    "nickname"
    t.string    "open_id"
  end
  ...
  create_table "campaigns", force: true do |t|
    ...
    t.timestamp "bulk_submitted_at",                 precision: 6
    t.timestamp "bulk_ordered_at",                   precision: 6
    t.boolean   "is_summary_emailed",                              default: false
    t.timestamp "summary_emailed_at",                precision: 6
  ...
  create_table "email_share_histories", force: true do |t|
    ...
    t.integer   "seller_id"
    t.timestamp "date_sent",  precision: 6
    t.timestamp "created_at", precision: 6
    t.timestamp "updated_at", precision: 6
  end
  ...
  create_table "ent_orders", force: true do |t|
    t.integer   "campaign_id"
    t.integer   "seller_id"
    t.timestamp "order_date",              precision: 6
    t.string    "status"
  ...
  create_table "items", force: true do |t|
    ...
    t.timestamp "delivery_updated_at",    precision: 6
    t.string    "rec_id"
  ...
  create_table "option_group_properties", force: true do |t|
    ...
    t.timestamp "inventory_last_update_time", precision: 6
  ...
  create_table "pv_transmission_calendars", force: true do |t|
    ...
    t.timestamp "delivery_date",   precision: 6
    t.timestamp "submission_date", precision: 6
  end
  ...
  create_table "social_share_histories", force: true do |t|
    ...
    t.integer   "media_id"
    t.string    "post_id"
    t.timestamp "date_shared", precision: 6
  end
  ...
  create_table "users", force: true do |t|
    ...
    t.timestamp "oauth_expires_at",       precision: 6
    t.timestamp "created_at",             precision: 6
    t.timestamp "updated_at",             precision: 6
