class CampaignsController < ApplicationController
  ...
  include ActionView::Helpers::NumberHelper
    ...
    def campaign_params
        params.require(:campaign).permit :product_id,:logo,:minilogo,:is_featured,:receiver, :title, :organizer_quote, :campaign_mode, :goal, :seller_goal, :seller_compassion_goal, :display_seller_goal, :end_date, :organizer_quote, :description, :collection_id, :call_to_action, :allow_direct_donation, :active
    end
